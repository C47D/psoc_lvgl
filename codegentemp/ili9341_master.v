// ======================================================================
// ili9341_master.v generated from TopDesign.cysch
// 01/05/2021 at 10:00
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=3, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=194, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=3, DitherOffset=0, EnableMode=2, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=200, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=true, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_Base, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Base, CY_INSTANCE_SHORT_NAME=PWM_Base, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_Base, )
module PWM_v3_30_5 (
    capture,
    clock,
    cmp_sel,
...
module top ;
	...
	wire [0:0] tmpOE__DISP_RST_net;
	wire [0:0] tmpFB_0__DISP_RST_net;
	wire [0:0] tmpIO_0__DISP_RST_net;
	wire [0:0] tmpINTERRUPT_0__DISP_RST_net;
	...
	assign tmpOE__DISP_RST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DISP_BCKL_net;
	wire [0:0] tmpFB_0__DISP_BCKL_net;
	wire [0:0] tmpIO_0__DISP_BCKL_net;
	wire [0:0] tmpINTERRUPT_0__DISP_BCKL_net;
	electrical [0:0] tmpSIOVREF__DISP_BCKL_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a96ff373-5e52-4610-8746-7f7de95f6405"),
		  ...
		  .input_buffer_sel(2'b00))
		DISP_BCKL
		 (.oe(tmpOE__DISP_BCKL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DISP_BCKL_net[0:0]}),
		  .io({tmpIO_0__DISP_BCKL_net[0:0]}),
		  .siovref(tmpSIOVREF__DISP_BCKL_net),
		  .interrupt({tmpINTERRUPT_0__DISP_BCKL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DISP_BCKL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DISP_DC_net;
	wire [0:0] tmpFB_0__DISP_DC_net;
	wire [0:0] tmpIO_0__DISP_DC_net;
	wire [0:0] tmpINTERRUPT_0__DISP_DC_net;
	electrical [0:0] tmpSIOVREF__DISP_DC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("16896221-588e-43a7-b325-6d784e5dcd46"),
		  ...
		  .input_buffer_sel(2'b00))
		DISP_DC
		 (.oe(tmpOE__DISP_DC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DISP_DC_net[0:0]}),
		  .io({tmpIO_0__DISP_DC_net[0:0]}),
		  .siovref(tmpSIOVREF__DISP_DC_net),
		  .interrupt({tmpINTERRUPT_0__DISP_DC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DISP_DC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__QuadDec_SW_net;
	wire [0:0] tmpFB_0__QuadDec_SW_net;
	wire [0:0] tmpIO_0__QuadDec_SW_net;
	wire [0:0] tmpINTERRUPT_0__QuadDec_SW_net;
	electrical [0:0] tmpSIOVREF__QuadDec_SW_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4a9ca766-413b-431a-94cf-5a4f1e1283fc"),
		  ...
		  .input_buffer_sel(2'b00))
		QuadDec_SW
		 (.oe(tmpOE__QuadDec_SW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__QuadDec_SW_net[0:0]}),
		  .io({tmpIO_0__QuadDec_SW_net[0:0]}),
		  .siovref(tmpSIOVREF__QuadDec_SW_net),
		  .interrupt({tmpINTERRUPT_0__QuadDec_SW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__QuadDec_SW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_4 PWM_Tren (
        ...
        .tc(Net_62),
        .trigger(1'b0));
    defparam PWM_Tren.Resolution = 8;

    PWM_v3_30_5 PWM_Base (
        .capture(1'b0),
        .clock(Net_754),
        .cmp_sel(1'b0),
        .enable(enable),
        ...
        .tc(Net_72),
        .trigger(1'b0));
    defparam PWM_Base.Resolution = 8;


    assign Net_680 = Net_754 & gate[0];


    assign Net_755[0] = Net_724 & Net_58;


    assign Net_755[1] = Net_89 & Net_724;
	...
	wire [0:0] tmpOE__TXgate_net;
	wire [0:0] tmpFB_0__TXgate_net;
	wire [0:0] tmpIO_0__TXgate_net;
	wire [0:0] tmpINTERRUPT_0__TXgate_net;
	electrical [0:0] tmpSIOVREF__TXgate_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("7e8dae0a-679b-4bc5-b5e2-8f16a1b97535"),
		  ...
		  .input_buffer_sel(2'b00))
		TXgate
		 (.oe(tmpOE__TXgate_net),
		  .y({Net_680}),
		  .fb({tmpFB_0__TXgate_net[0:0]}),
		  .io({tmpIO_0__TXgate_net[0:0]}),
		  .siovref(tmpSIOVREF__TXgate_net),
		  .interrupt({tmpINTERRUPT_0__TXgate_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TXgate_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_724)
    begin
        cydff_1 <= Net_309;
    end
    assign Net_58 = cydff_1;
    // -- DFF End --


    assign Net_309 = ~Net_58;


    assign Net_89 = ~Net_58;
    ...
    cy_sync_v1_0 Sync (
        ...
        .s_in(Net_755[1:0]),
        .s_out(gate[1:0]));
    defparam Sync.SignalWidth = 2;

	wire [0:0] tmpOE__Rx_gate_net;
	wire [0:0] tmpFB_0__Rx_gate_net;
	wire [0:0] tmpIO_0__Rx_gate_net;
	wire [0:0] tmpINTERRUPT_0__Rx_gate_net;
	electrical [0:0] tmpSIOVREF__Rx_gate_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c39a5e9c-b25a-45e6-96e5-7b337baede83"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_gate
		 (.oe(tmpOE__Rx_gate_net),
		  .y({gate[1]}),
		  .fb({tmpFB_0__Rx_gate_net[0:0]}),
		  .io({tmpIO_0__Rx_gate_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_gate_net),
		  .interrupt({tmpINTERRUPT_0__Rx_gate_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_gate_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
